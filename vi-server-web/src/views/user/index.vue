<template>
  <div class="app-container">
    ...
    <div class="head-container">
      <el-input v-model="query.userName" clearable size="mini" placeholder="请输入用户名" style="width: 200px; margin-right: 5px" class="filter-item" @keyup.enter.native="toQuery" />
