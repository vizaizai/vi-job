...
import com.github.vizaizai.remote.common.SystemProps;
...
public class NetUtils {
    ...
    public static String getLocalHost() {
        ...
        String addressFromJVM = System.getProperty(SystemProps.BIND_LOCAL_ADDRESS);
        if (StringUtils.isNotEmpty(addressFromJVM)) {
            log.info("[Net] use address from[{}]: {}", SystemProps.BIND_LOCAL_ADDRESS, addressFromJVM);
     ...
     * the property value from {@link SystemProps#PREFERRED_NETWORK_INTERFACE}, return <code>true</code>,
     * or <code>false</code>
     */
    public static boolean isPreferredNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = System.getProperty(SystemProps.PREFERRED_NETWORK_INTERFACE);
    ...
    static boolean ignoreInterfaceByConfig(String interfaceName) {
        String regex = System.getProperty(SystemProps.IGNORED_NETWORK_INTERFACE_REGEX);
